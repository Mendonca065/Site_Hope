...
function __OriginkitBase_NeonBorder(props: Props) {
    const {
...
export default function NeonBorder(props: Record<string, unknown>) {
  return <__OriginkitBase_NeonBorder {...(__originkitPresetProps as Record<string, unknown>)} {...props} />;
}
